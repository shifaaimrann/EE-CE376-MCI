...
void display_hex(uint8_t n)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1, (p & 0x01) ? GPIO_PIN_SET : GPIO_PIN_RESET); // a
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2, (p & 0x02) ? GPIO_PIN_SET : GPIO_PIN_RESET); // b
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, (p & 0x04) ? GPIO_PIN_SET : GPIO_PIN_RESET); // c
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, (p & 0x08) ? GPIO_PIN_SET : GPIO_PIN_RESET); // d
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, (p & 0x10) ? GPIO_PIN_SET : GPIO_PIN_RESET); // e
