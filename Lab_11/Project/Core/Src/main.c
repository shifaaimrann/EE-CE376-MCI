...
int main(void)
{
  ...
  Motor_Init();  // Sets up TIM3 PWM channels [cite: 297]
  IMU_Init();    // Configures Accel/Gyro and handles initial calibration [cite: 265]
  BT_Init();     // Starts UART Interrupt for real-time gain tuning

  /* 2. Start the Fixed-Rate Control Timer (200 Hz) */
  // This triggers the HAL_TIM_PeriodElapsedCallback every 5ms [cite: 211, 267]
